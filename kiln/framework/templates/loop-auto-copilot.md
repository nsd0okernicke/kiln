...
4. **Delegate the work** — call `python .kiln/tools/set-status.py {{ROLE}} delegating {{ROLE}}-worker` first. Then do not implement anything yourself. Delegate this task entirely to the
