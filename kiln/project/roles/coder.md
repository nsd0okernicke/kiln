...
1. **Unit tests pass** — Run the full unit test suite. All tests must pass.
2. **Coverage meets threshold** — Use `/coverage-check` to run coverage. Increase coverage where reasonable; the project's threshold is defined in the constitution.
